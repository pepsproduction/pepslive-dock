...
- Firebase Match Room หนึ่งห้องมี Dock Host ผู้เขียนเพียงหนึ่งแท็บ; Viewer ทั่วไปอ่านและคัดลอกข้อมูลได้เท่านั้น ส่วน Viewer ที่ยืนยัน Anonymous UID ตรงกับ Host แก้ได้เฉพาะฐานสีทีม ไม่สามารถแก้คะแนน
